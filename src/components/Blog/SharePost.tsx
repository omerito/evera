  ...
  return (
    <>
      <button
        ...
        className="inline-flex items-center justify-center mb-3 duration-300 rounded-sm h-9 w-9 bg-gray-light text-body-color hover:bg-orange-500 hover:text-white dark:bg-gray-dark dark:hover:bg-orange-500 sm:ml-3"
      >
        <svg
          width="16"
          height="16"
      ...
      <button
        ...
        className="inline-flex items-center justify-center mb-3 ml-3 duration-300 rounded-sm h-9 w-9 bg-gray-light text-body-color hover:bg-orange-500 hover:text-white dark:bg-gray-dark dark:hover:bg-orange-500"
      >
        <svg
          width="18"
          height="18"
